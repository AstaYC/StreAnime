            ...
            <div class="table-responsive">
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-5">
                                <h2>Hidden Episode <b>Management</b></h2>
                            </div>
          ...
          <div class="modal-dialog" style="max-width: 700px;">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title">Recuperation Episode</h4>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
                        <!-- Modal Body -->
                        <div class="modal-body">
                            <!-- Delete medicine form -->
                            <form method="POST" action="/hiddenEpisode/recuperate">
                            @csrf
                                <input type="hidden" name="action" value="delete">
                                <input type="hidden" name="id" value="{{$episode->id}}">
                                <p>Are you sure you want to Recuperer this Episode "{{$episode->titre}}"?</p>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                    <button type="submit" class="btn btn-primary">Recuperer Episode</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
<div class="modal" id="deleteCategoryModal{{$episode->id}}">										
   <div class="modal-dialog" style="max-width: 700px;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- Delete medicine form -->
                    <form method="POST" action="/hiddenEpisode/delete">
                    @csrf
                        <input type="hidden" name="action" value="delete">
                        <input type="hidden" name="id" value="{{$episode->id}}">
                        <p>Are you sure you want to delete this Episode "{{$episode->titre}}"?</p>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
